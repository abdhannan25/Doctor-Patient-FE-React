    ...
    <div className='body1'>
        ...
        <div class="d-flex flex-row mb-3">
            <div className='form mt-3 p-2 ps-5 pe-5'>
                <h4 className='mt-4 fw-bold text-black mb-4 text-center'>Doctor SignUp</h4>
            ...
            <div className='welcome text-center'>
                <h3 className='text-black fw-bolder mt-5 pt-5 ps-5 pe-5'>Welcome to Patient Care!</h3>
                <p className='fw-bold mt-4 ps-5 pe-5 text-black'>Providing you patients at your ease</p>
                <div className='div1'>
                Already have an account? <Link to='/DoctorLogin' className='fw-bold text-black'>Login</Link>
                </div>   
                <div className='div2'>
                Or continue with
                </div>
